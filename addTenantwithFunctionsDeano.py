...
#  Ask user for Tenant, EPG and contract	
	myTenancyanswer = raw_input("New Tenant Name :")
	myEPGanswer = raw_input("New Tenant Name :")
	myContractanswer = raw_input("New Tenant Name :")
